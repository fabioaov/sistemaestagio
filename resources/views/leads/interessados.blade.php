                ...
                <x-table :headers="['ID', 'CNPJ', 'Nome fantasia', 'Razão social', 'E-mail', 'Telefone', 'Representante', 'Responsável', 'Ações']">
                    @foreach ($leads as $lead)
                        ...
                        <x-multi-dropdown :id="'mover_dropdown_' . $lead->id">
                            <x-multi-dropdown-link :href="route('leads.mover', ['idLead' => $lead->id, 'status' => 4])" data-titulo="Mover lead" data-texto="Tem certeza que deseja mover este lead?" data-method="put">
                                Funil de vendas
                            </x-multi-dropdown-link>
